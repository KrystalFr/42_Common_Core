...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/13 06:22:18 by leG               #+#    #+#             */
/*   Updated: 2025/02/17 13:38:06 by gaperaud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					ft_gnl_strlcpy(char *dest, const char *src, int l);
...
int						ft_print_lowerhexa_recursive(unsigned int n,
							int *compt);
int						ft_print_upperhexa_recursive(unsigned int n,
							int *compt);
